...
const ImagesData = [
  {
    img: "./hexbell-project/images/product-img1.svg",
    img2: "./hexbell-project/images/product-img2.svg",
  ...
  return (
    <div className={styles.productMainDiv}>
      <div className={styles.productLeftDiv}>
        <img
          img={process.env.PUBLIC_URL +"./hexbell-project/images/category-bg-img.svg"}
          ...
          <div className={styles.cartProductMainDiv}>
            <div className={styles.cartProductDiv}>
              <img
                ...
                src={"./hexbell-project/images/product-img1.svg"}
              />
